...
#ifndef SHMIPCC_SHMIPCMESSAGEHEADER_H
#define SHMIPCC_SHMIPCMESSAGEHEADER_H

/**
    length	 4 Byte	消息总长度，包含 Header。 (大端)
    version	 1 Byte	协议版本号，用于后续迭代更新。
    type	 1 Byte	消息类型
    fd_count 1 Byte fd_count 消息传输的fd数量。
 */
#include <cstdint>
#include <vector>
#include <arpa/inet.h>
...
#endif //SHMIPCC_SHMIPCMESSAGEHEADER_H
